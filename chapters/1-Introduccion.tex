...
\noindent Existe una gran variedad de técnicas para cargar código externo
...
\noindent Este es el caso de la mayoría de aplicaciones desarrolladas
en \textit{Java}.
...
\noindent Independientemente de la capacidad de carga de componentes,
...
\noindent La \textit{NES} es una muy importante para la historia
...
\noindent También es necesario \textbf{estabilizar y mejorar}
...
\noindent En este apartado se detallarán diferentes objetivos.
...
\noindent Estas tecnologías se desarrollarán al mismo tiempo que el propio entorno
...
\noindent Este entorno de desarrollo será muy similar al proporcionado
...
\noindent A diferencia del entorno de desarrollo \textit{MIPS32}, el entorno
...
\noindent Debido a que la aplicación principal es muy compleja,
...
\noindent Toda la metodología ha sido implementada mediante
...
\noindent El componente con el entorno de desarrollo \textit{NES}
