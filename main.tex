...
\begin{document}
    ...
    \listoffigures
    \mainmatter
    \include{chapters/ex-Antecedentes}
    \include{chapters/1-Introduction}
    \include{chapters/2-BaseDevelopment}
    \include{chapters/3-EntornoMIPS32}
    \include{chapters/4-Herramientas}
    \include{chapters/5-Conclusiones}
